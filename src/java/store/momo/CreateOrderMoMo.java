...
public class CreateOrderMoMo extends AbstractProcess<PaymentRequest, PaymentResponse> {
    ...
    public static PaymentResponse process(Environment env, String orderId, String requestId, String amount, String orderInfo, String returnURL, String notifyURL, String extraData, RequestType requestType) throws Exception {
        try {
    ...
    public PaymentResponse execute(PaymentRequest request) throws MoMoException {
        ...
        } catch (JsonSyntaxException | MoMoException exception) {
