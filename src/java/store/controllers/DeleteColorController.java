 ...
 * @author giama
 */
@WebServlet(name = "DeleteColorController", urlPatterns = {"/DeleteColorController"})
public class DeleteColorController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = dao.deleteColor(productColorID);
            if (check) {
                request.setAttribute("MESSAGE", "Màu " + color + " đã được xoá thành công.");
                url = SUCCESS;
            }
