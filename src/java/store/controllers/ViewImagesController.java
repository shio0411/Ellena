 ...
 * @author giama
 */
@WebServlet(name = "ViewImagesController", urlPatterns = {"/ViewImagesController"})
public class ViewImagesController extends HttpServlet {
    private static final String ERROR = "error.jsp";
    private static final String SUCCESS = "view-product-images.jsp";
    /**
