 ...
 * @author giama
 */
@WebServlet(name = "CustomerViewOrderDetailController", urlPatterns = {"/CustomerViewOrderDetailController"})
public class CustomerViewOrderDetailController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("Error at CustomerViewOrderDetailsController: " + e.toString());
        } finally {
