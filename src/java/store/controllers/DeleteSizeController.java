 ...
 * @author giama
 */
@WebServlet(name = "DeleteSizeController", urlPatterns = {"/DeleteSizeController"})
public class DeleteSizeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = dao.deleteSize(productColorID, size);
            if (check) {
                request.setAttribute("MESSAGE", "Size " + size + " đã được xoá thành công.");
