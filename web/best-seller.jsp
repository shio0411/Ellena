<%-- 
    Document   : best-seller.jsp
    Created on : Jun 8, 2022, 3:38:25 PM
    Author     : VP
--%>
            ...
            <div class="row">
                <div class="col-lg-5 col-md-5">
                    <div class="section-title">
                        <h4 id="noi-bat">Sản phẩm bán chạy</h4>
                    </div>
                </div>
            </div>
                    ...
                    <div class="product__item">
                        <div class="product__item__pic set-bg">
                            <%
                                ...
                                {
                            %>
                            <div id="best-seller-product-<%=product.getProductID()%>" class="carousel slide" data-ride="carousel" data-interval="false">
                                ...
                                <a class="carousel-control-prev"  data-target="#best-seller-product-<%=product.getProductID()%>" role="button" data-slide="prev">
                        ...
                        <div class="product__item__text">
                            ...
                            <div class="">
                                <span class = "product__price text-danger"><%= (int)(product.getPrice()/1000*(1-product.getDiscount()))%>.000đ <span class="original-price"><s>   <%=product.getPrice()/1000%>.000đ  </s></span></span>
                                  
                                <span class = "product__price text-danger"> -<%=(int)(product.getDiscount()*100)%>%</span>
                            </div>
                            <%
                                }else{
                                %>
