                                    ...
                                    <div class="modal-dialog" id="<%=id%>" >
                                        <div class="modal-content" >
                                            ...
                                            <form action="UpdateOrderDetailController" method="POST">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-default" <% if (order.getOrderID() != 4) {%> disabled="" <%}%> type="submit" name="action" value="UpdateOrderDetail">Cập nhật</button>
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
                                                </div>
                                            </form>
                                        </div>
                                    ...
                                    <div class="modal-dialog" id="<%=id%>" >
                                        <div class="modal-content" >
                                            ...
                                            <form action="RefundOrderController">
                                                ...
                                                <input type="hidden" name="orderDetailID" value="<%= orderDetail.getOrderDetailID()%>"/>
                                                <div class="modal-footer">
                                                    <button class="btn btn-default" <% if (order.getOrderID() != 4) {%> disabled="" <%}%> type="submit" name="action" value="RefundOrder">Cập nhật</button>
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
                                                </div>
                                            </form>
                                        </div>
