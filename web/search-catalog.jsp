                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-9">
                        ...
                        <div class="row pagination__option" style="justify-content: center; align-items: center; text-align: center;">
                            ...
                            %>
                            <a href="SearchCatalogController?search=<%= search %>&page=<%= i%>" style="text-decoration: none;"><%= i%></a>
                            <%
                                    }
                                }
                            %>
                            ...
                            <!-- For displaying 1st page link except for the 1st page -->
                            <a href="FilterSearchedProductsController?search=<%= search %>&listColors=<%= colorListSearch%>&listSizes=<%= sizeListSearch%>&minAmount=<%= minAmount%>&maxAmount=<%= maxAmount%>&page=1"><i class="glyphicon glyphicon-menu-left"></i><i class="glyphicon glyphicon-menu-left"></i></a>

                            <!-- For displaying Previous link except for the 1st page -->
                            <a href="FilterSearchedProductsController?search=<%= search %>&listColors=<%= colorListSearch%>&listSizes=<%= sizeListSearch%>&minAmount=<%= minAmount%>&maxAmount=<%= maxAmount%>&page=<%= currentPage - 1%>" style="text-decoration: none;"><i class="glyphicon glyphicon-menu-left"></i></a>
                                <%
                                    }
                                %>
                            ...
                            %>
                            <a href="FilterSearchedProductsController?search=<%= search %>&listColors=<%= colorListSearch%>&listSizes=<%= sizeListSearch%>&minAmount=<%= minAmount%>&maxAmount=<%= maxAmount%>&page=<%= i%>"><%= i%></a>
                            <%
                                    }
                                }
                            %>
                            ...
                            <%
                                if (currentPage < noOfPages) {
                            %>
                            <a href="FilterSearchedProductsController?search=<%= search %>&listColors=<%= colorListSearch%>&listSizes=<%= sizeListSearch%>&minAmount=<%= minAmount%>&maxAmount=<%= maxAmount%>&page=<%= currentPage + 1%>"><i class="glyphicon glyphicon-menu-right"></i></a>

                            <!-- For displaying last page link except for the last page -->
                            <a href="FilterSearchedProductsController?search=<%= search %>&listColors=<%= colorListSearch%>&listSizes=<%= sizeListSearch%>&minAmount=<%= minAmount%>&maxAmount=<%= maxAmount%>&page=<%= noOfPages%>"><i class="glyphicon glyphicon-menu-right"></i><i class="glyphicon glyphicon-menu-right"></i></a>
