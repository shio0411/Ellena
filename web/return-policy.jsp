                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="3" style="width:513.9pt;border:solid #BFBFBF 1.0pt;border-top:none;padding:0cm 5.4pt 0cm 5.4pt;height:  24.75pt;">
                            <p style="margin-top:0cm;margin-right:0cm;margin-bottom:0cm;margin-left:0cm;line-height:normal;font-size:15px;font-family: Montserrat ,sans-serif;text-align:center;"><strong><span style="font-size:21px;font-family: Montserrat ,serif;">QUY ĐỊNH ĐỔI SẢN PHẨM</span></strong></p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="width:436.35pt;border-top:none;border-left:  none;border-bottom:solid #BFBFBF 1.0pt;border-right:solid #BFBFBF 1.0pt;padding:0cm 5.4pt 0cm 5.4pt;height:  40pt;">
                            ...
                            <p style="margin-top:0cm;margin-right:0cm;margin-bottom:0cm;margin-left:0cm;line-height:normal;font-size:15px;font-family: Montserrat ,sans-serif;"><span style="font-size:14px;font-family: Montserrat ,serif;">- Thời gian kể từ ngày nhận sản phẩm: không quá 15 ngày.</span></p>
                        </td>
                    </tr>
                    <tr>
