...
<html>
    ...
    <body>
        ...
        <div class="main">
            ...
            <ul class="pagination">
                <li><a href="MainController?action=Return&orderID=<%= order.getOrderID()%>">Đổi</a></li>
                <li class="active"><a href="#">Trả</a></li>
            </ul>
                                    ...
                                    <div class="modal-dialog" id="<%=id%>" >
                                        <div class="modal-content" >
                                            ...
                                            <form action="MainController">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-default" type="submit" name="action" value="RefundOrder">Cập nhật</button>
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
                                                </div>
                                            </form>
                                        </div>
